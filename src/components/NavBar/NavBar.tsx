...
export default function NavBar(props: NavBarProps) {
  ...
  return (
    <div className="flex bg-gray-100">
      ...
      <div className="fixed rounded-full bg-teal-500 md:bottom-4 md:right-6 sm:right-2 sm:bottom-10 md:w-16 md:h-16 sm:w-12 sm:h-12 z-50 flex justify-center items-center cursor-pointer">
