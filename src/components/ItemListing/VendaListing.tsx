...
const ListItem: React.FC<ListItemProps> = ({
  ...
  return (
    <button className={`border-b relative border-gray-200 hover:bg-indigo-50 w-full text-left text-sm ${index % 2 === 0 ? "bg-white" : "bg-gray-50" }`}>
      <div className="py-2 flex lg:items-center flex-col lg:flex-row px-8 lg:h-24 w-full">
        ...
        <div className="2xl:w-[235px] xl:w-[200px] md:w-[150px] pr-10">
          <div className="lg:hidden py-2">
            <h1 className="font-semibold">Produto</h1>
          </div>
        ...
        <div className="flex-col xl:w-[185px] md:w-[170px] sm:px-10">
          ...
          <div className={`${statusBgColor} w-min px-2 rounded-xl mb-1`}>
        ...
        <div className="lg:w-fit w-full">
          <div className="lg:hidden py-2">
            <h1 className="font-semibold">Valor comissão</h1>
          </div>
  ...
  return (
    <div className="bg-white py-4 w-full">
      <div className="hidden lg:block">
        <div className="flex items-center w-full py-6 h-6 text-gray-900/50 bg-gray-50 border-b uppercase text-sm">
